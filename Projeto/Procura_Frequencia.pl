...
my %palavrasReservadas = map { $_ => 1 } qw(a à às ao aos o os e de desde da das do dos em entre dentro com consigo como
...
é são está estão era eram na nas no nos os as não ou sim certamente ao aos mais maior maioria mas porém contudo todavia cada qualquer que
